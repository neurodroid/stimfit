...
../../configure --enable-python --with-wx-config=/Users/cs/wxbin/bin/wx-config CPPFLAGS="-DH5_USE_16_API" CFLAGS="$arch_flags" CXXFLAGS="$arch_flags -I/Users/cs/wxbin/include/wx-2.9 -I/opt/local/include" LDFLAGS="$arch_flags -headerpad_max_install_names -L/Users/cs/wxbin/lib -L/opt/local/lib -L/usr/lib" PYTHON=/opt/local/bin/python
#/usr/bin/python
