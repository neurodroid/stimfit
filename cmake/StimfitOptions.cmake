...
if(APPLE)
  set(_stf_default_lapack_provider "ACCELERATE")
else()
  set(_stf_default_lapack_provider "AUTO")
endif()
set(STF_LAPACK_PROVIDER "${_stf_default_lapack_provider}" CACHE STRING
  "LAPACK/BLAS provider (AUTO, ACCELERATE, OPENBLAS, or LEGACY)")
set_property(CACHE STF_LAPACK_PROVIDER PROPERTY STRINGS AUTO ACCELERATE OPENBLAS LEGACY)
unset(_stf_default_lapack_provider)
...
string(TOUPPER "${STF_LAPACK_PROVIDER}" STF_LAPACK_PROVIDER)
if(NOT STF_LAPACK_PROVIDER STREQUAL "AUTO"
   AND NOT STF_LAPACK_PROVIDER STREQUAL "ACCELERATE"
   AND NOT STF_LAPACK_PROVIDER STREQUAL "OPENBLAS"
   AND NOT STF_LAPACK_PROVIDER STREQUAL "LEGACY")
  message(FATAL_ERROR "STF_LAPACK_PROVIDER must be AUTO, ACCELERATE, OPENBLAS, or LEGACY")
endif()
