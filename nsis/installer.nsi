...
!define USRDRV "C:\"
!define LOGIN "cs"
!define PRODUCT_VERSION "0.10.21"
!define WXW_VERSION "2.9.1.1"
!define WXW_VERSION_SHORT "291"
!define PY_VERSION "2.7.2"
!define PY_MAJOR "2.7"
!define PY_MIN "2.7"
Var PY_ACT
!define NP_VERSION "1.6.1"
...
!define WXWDIR "${USRDRV}Users\${LOGIN}\wxPython-${WXW_VERSION}"
!define WXPDIR "${USRDRV}Users\${LOGIN}\wxPython-${WXW_VERSION}\site-packages"
...
Section "!Program files and wxPython" 3 ; Core program files and wxPython
  ...
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}u_core_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxbase${WXW_VERSION_SHORT}u_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}u_aui_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}u_adv_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxbase${WXW_VERSION_SHORT}u_net_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}u_html_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}u_stc_vc.dll"
  ...
  File "${STFDIR}\src\stfswig\embedded_mpl.py"
  File "${STFDIR}\src\stfswig\embedded_ipython.py"
  File "${STFDIR}\src\stfswig\unittest_stfio.py"
  File "${STFDIR}\src\stfswig\heka.py"
  File "${STFDIR}\src\stfswig\extensions.py"
