...
!define WXPDIR "${USRDRV}Users\${LOGIN}\wxWidgets-${WXW_VERSION}\wxPython\final.build\Lib\site-packages"
...
Section "!Program files and wxPython" 3 ; Core program files and wxPython
  ...
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}uh_core_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxbase${WXW_VERSION_SHORT}uh_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}uh_aui_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}uh_adv_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxbase${WXW_VERSION_SHORT}uh_net_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}uh_html_vc.dll"
  File "${WXWDIR}\lib\vc_dll\wxmsw${WXW_VERSION_SHORT}uh_stc_vc.dll"
